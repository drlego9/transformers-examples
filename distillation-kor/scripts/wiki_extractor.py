...
def process_dump(input_file, template_file, out_file, file_size, file_compress,
    ...
    logging.info("total of page: %d, total of article page: %d; total of used article page: %d" % (g_page_total, g_page_articl_total,g_page_articl_used_total))
...
def main():
    ...
    parser = argparse.ArgumentParser(prog=os.path.basename(sys.argv[0]),
                                     ...
                                     description=__doc__)
    parser.add_argument("--input", required=True, help="XML wiki dump file")
